...
class MixerBlock(eqx.Module):
    ...
    def __call__(self, y):
        ...
        mixed_map = jax.vmap(self.patch_mixer)(self.norm1(y))
        print(f'after applying mixer: {mixed_map.shape}')
        y = y + mixed_map
        y = einops.rearrange(y, "c p -> p c")
        print(f'after rearrange: {y.shape}')
...
class Mixer2d(eqx.Module):
    ...
    def __init__(
        ...
        *,
        ...
        self.params = [('img_size', img_size), ('patch_size', patch_size), ('hidden_size',hidden_size), 
                           ('mix_patch_size',mix_patch_size), ('mix_hidden_size', mix_hidden_size), ('num_blocks', num_blocks)]
    ...
    def __call__(self, t, y):
        ...
        print(f'conv inputs: {self.params}')
        
        # y after convolution: (64, 7, 7)
